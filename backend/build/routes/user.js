...
router.post(`/login/`, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const loginResponse = yield user_1.default.tryLogin(req.body.username, req.body.password);
...
router.post('/changepassword/', middleware_1.default.userExtractor, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield user_1.default.changePassword(req.body.password, req.user);
    res.status(200).send(result);
}));
