...
const addDoneWord = (wordId, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const rawDoneWord = { word: wordId, date: new Date(), user: user._id };
    const newDoneWord = new DoneWord_1.doneWordModel(rawDoneWord);
...
const getDoneWords = (user) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield DoneWord_1.doneWordModel.find({ user: user._id });
    if (!result) {
...
const changePassword = (rawPassword, user) => __awaiter(void 0, void 0, void 0, function* () {
    const password = yield createPasswordHash(parsePassword(rawPassword));
    const result = yield User_1.userModel.updateOne({ _id: user._id }, { password });
    return result;
});
exports.default = {
    createUser,
