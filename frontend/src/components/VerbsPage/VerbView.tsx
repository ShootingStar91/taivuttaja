...
export const VerbView = () => {
  ...
  const getTable = (words: Word[]) => {
    return (
      <table className="-ml-4 overflow-auto">
        <thead>
        ...
        <tbody>
          {words.map((d) => (
            <React.Fragment key={d._id}>
              <tr>
                <td className="min-w-[150px] justify-start whitespace-nowrap align-center font-bold">
                  {d.tense}
                </td>
              </tr>
  ...
  return (
    <div className="text-xs -ml-2 sm:-ml-4 -mr-4">
