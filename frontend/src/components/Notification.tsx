...
export const Notification = () => {
  ...
  return (
    <div id='toast-default' className={'fixed top-[5%] right-[5%] flex items-center w-full max-w-xs p-4 rounded-sm shadow z-50' + ' ' + getColor(notification.type)} role='alert' onClick={() => clearToast()}>
